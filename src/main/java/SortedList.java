...
public class SortedList<T> implements Collection<T> {
    ...
    public SortedList(SortedList<T> sortedListA) {
        this(sortedListA.list, sortedListA.comparator);
    }
    ...
    public SortedList<T> clone(){
        return new SortedList<T>((ArrayList<T>) this.list.clone(), this.comparator);
    }
}
